...
# no SSH to the host. Reuses scripts/deploy.env (PORTAINER_URL, PORTAINER_TOKEN,
...
#
# Examples:
#   ./scripts/portainer-exec.sh grupo-vidalar-app-1 php -i
#   ./scripts/portainer-exec.sh grupo-vidalar-app-1 sh -c 'php -i | grep memory_limit'
set -euo pipefail
