---
name: upgrade-rebase
description: Guide through rebasing Avuz customization commits onto a new Nextcloud stable branch. Run after upgrade-scan.
...
14. Remind the user to run `/upgrade-verify` next.
