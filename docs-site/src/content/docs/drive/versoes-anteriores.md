...
<video src="/assets/drive/versoes-anteriores.mp4" muted autoplay loop playsinline controls></video>

:::tip
Cada vez que o arquivo muda, o Drive guarda a versão antiga — dá para restaurá-la a qualquer momento pela aba Versões.
:::
